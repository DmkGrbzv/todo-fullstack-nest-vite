  ...
  <div class="item-wrapper">
    <div class="item">
      <label for="" class="item__label" :class="{'item__label-done':  isSelectedValue}">
        ...
        <input ref="item" type="text" v-model="value" v-show="!isEditMode"  @blur="getTextValue(isChangedTextValue)" :class="{'item__label-done': isSelectedValue}" v-on:focusout="isEditMode = true">
